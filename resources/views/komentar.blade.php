...
@section('content')
    <div class="bg-green-600 w-90 relative rounded-3xl ">
        <div class="flex p-3 text-white">
            <img class="rounded-full size-10" src="/assets/images/Monyet.jpeg" alt="">
        ...
        <div class="py-[10px] px-[23px] bg-gray-300 rounded-4xl absolute bottom-2.5 left-2.5 w-85 h-8 items-center ">
